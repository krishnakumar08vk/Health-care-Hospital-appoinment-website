    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            <li>
              <a href="mailto:support@healthplus.com">support@RamHealthcare.com</a>
            </li>
            <li>
              <a href="mailto:appointment@healthplus.com">
                Hospital@ramhealthcare.com
              </a>
            </li>
            <li>
      ...
      <div className="ft-copyright">
        <p>© 2025 RamHealth care. All rights reserved.</p>

        <ul className="ft-social-links">
          <li>
            <a
              href="www.linkedin.com/in/krishna-kumar-be"
              title="LinkedIn"
              target="_blank"
